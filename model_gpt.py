...
@register_model_architecture('transformer_lm', 'transformer_lm_gpt2_base_plus')
def transformer_lm_gpt2_base_plus(args):
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 864)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 3600)
...
@register_model_architecture('transformer_lm', 'transformer_lm_gpt_9_576')
def transformer_lm_gpt_9_576(args):
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 576)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 3072)
...
@register_model_architecture('transformer_lm', 'transformer_lm_gpt_8_480')
def transformer_lm_gpt_8_480(args):
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 480)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 3072)
...
@register_model_architecture('transformer_lm', 'transformer_lm_gpt_6_384')
def transformer_lm_gpt_6_384(args):
