...
@register_model_architecture('roberta', 'roberta_9_576')
def roberta_9_576_architecture(args):
...
def roberta_small_architecture(args):
    args.encoder_layers = getattr(args, 'cencoder_layers', 3)
    base_architecture(args)

@register_model_architecture('roberta', 'roberta_4layer')
def roberta_4layer_architecture(args):
