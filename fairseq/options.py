...
def add_distil_arg(parser):
    group = parser.add_argument_group('Back_distillation')
    group.add_argument('--temperature_distil', default=2., type=float)
    group.add_argument('--distil_then_mlm', default=0, type=int)
    group.add_argument('--restrict_ce_to_mask', default=False, action='store_true')
    group.add_argument('--max-update-distil', default=0, type=int)
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--restore-file-distil-from', default='my_name_is_teacher')
    group.add_argument('--restore-file-checkpoint-distil-from', default='my_name_is_teacher')
...
def add_model_args(parser):
    ...
    group.add_argument('--arch_distil_from', required=True,
                       choices=ARCH_MODEL_REGISTRY.keys(),
