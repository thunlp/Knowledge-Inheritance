...
def convert_roberta_checkpoint_to_pytorch(
    roberta_checkpoint_path: str, checkpoint_name: str, pytorch_dump_folder_path: str, classification_head: bool
):
    """
...
if __name__ == "__main__":
    path = "./ckpt_BIO_3k_5k_from_teacher/"
    dir_list = os.listdir(path)
    for i, roberta_checkpoint_name in enumerate(dir_list):
        roberta_checkpoint_path = path + roberta_checkpoint_name
        print(i, len(dir_list), roberta_checkpoint_path)
        checkpoint_name = "checkpoint_last.pt"
        pytorch_dump_folder_path = "./checkpoints_hf/ckpt_BIO_3k_5k_from_teacher/" + roberta_checkpoint_name
        classification_head = False
        convert_roberta_checkpoint_to_pytorch(
            roberta_checkpoint_path, checkpoint_name, pytorch_dump_folder_path, classification_head
        )
