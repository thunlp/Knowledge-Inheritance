...
@register_model_architecture('roberta', 'roberta_base_plus')
def roberta_base_plus_architecture(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 18)
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 864)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 3600)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 12)
    base_architecture(args)
...
def roberta_medium_architecture(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    base_architecture(args)

@register_model_architecture('roberta', 'roberta_9layer_576')
def roberta_9layer_576_architecture(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 9)
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 576)
    base_architecture(args)
...
@register_model_architecture('roberta', 'roberta_9layer')
def roberta_9layer_architecture(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 9)
    base_architecture(args)

@register_model_architecture('roberta', 'roberta_10layer')
def roberta_10layer_architecture(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 10)
    base_architecture(args)

@register_model_architecture('roberta', 'roberta_8layer')
def roberta_8layer_architecture(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 8)
    base_architecture(args)

@register_model_architecture('roberta', 'roberta_embed_dim_576')
def roberta_embed_dim_576_architecture(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 576)
    base_architecture(args)

@register_model_architecture('roberta', 'roberta_embed_dim_672')
def roberta_embed_dim_672_architecture(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 672)
    base_architecture(args)

@register_model_architecture('roberta', 'roberta_embed_dim_480')
def roberta_embed_dim_480_architecture(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 480)
    base_architecture(args)

@register_model_architecture('roberta', 'roberta_embed_dim_384')
def roberta_embed_dim_384_architecture(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 384)
    base_architecture(args)

@register_model_architecture('roberta', 'roberta_embed_dim_192')
def roberta_embed_dim_192_architecture(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 192)
    base_architecture(args)

@register_model_architecture('roberta', 'roberta_embed_dim_288')
def roberta_embed_dim_288_architecture(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 288)
    base_architecture(args)
